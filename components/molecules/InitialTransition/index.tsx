...
// Styles
import css from './initial-transition.module.scss';
        ...
        <LazyMotion features={domAnimation}>
            ...
            >
                <m.div variants={logoContainer} className={css.inner}>
                    <svg
                        className={cc([css.svg, css.outerCircle])}
                    ...
                    <svg
                        className={cc([css.svg, css.middleCircle])}
                        xmlns='http://www.w3.org/2000/svg'
                    ...
                    <svg
                        className={cc([css.svg, css.innerCircle])}
                        xmlns='http://www.w3.org/2000/svg'
